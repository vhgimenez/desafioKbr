    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
        ...
        <main class="col h-100 text-light p-4">
            <div class="d-flex align-items-end justify-content-between mb-4">
                ...
                <a href="{{ route('admin.index')}}" class="btn btn-light">Voltar</a>
            </div>

            <form action="{{ route('admin.update', $user) }}" method="POST" class="bg-custom rounded col-12 py-3 px-4">
                @method('PUT')
                @csrf
                <div class="mb-3 row">
                    <label for="usuario" class="col-sm-2 col-form-label">Usuário:</label>
                    <div class="col-sm-10">
                        <input type="text" value="{{ $user->name }}" name="name" class="form-control bg-dark text-light border-dark" id="usuario" placeholder="Ex: Admin" value="Admin">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" value="{{ $user->email }}" name="email" class="form-control bg-dark text-light border-dark" id="email" placeholder="Ex: admin@kbrtec.com.br" value="admin@kbrtec.com.br">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" name="passowrd" class="form-control bg-dark text-light border-dark" id="senha">
                    </div>
                </div>
                @if ($errors->any())
