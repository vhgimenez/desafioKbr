...
<body class="bg-dark h-100">
    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
                ...
                <div class="item">
                    ...
                    <div class="collapse show" id="menu-usuario">
                        <div class="bg-dark d-flex flex-column rounded mx-4 p-2 row-gap-1">
                            <a href="{{ route('admin.create') }}" class="submenu-link link-light text-decoration-none rounded p-2 active">
        ...
        <main class="col h-100 text-light p-4">
            ...
            <form action="{{ route('admin.store') }}" method="post" class="bg-custom rounded col-12 py-3 px-4">
                @csrf
                <div class="mb-3 row">
                    <label for="usuario" class="col-sm-2 col-form-label">Usuário:</label>
                    <div class="col-sm-10">
                        <input type="text" value="{{ old('name', "") }}" class="form-control bg-dark text-light border-dark" id="usuario" name="name" placeholder="Ex: Admin">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="email"  value="{{ old('email', "") }}" class="form-control bg-dark text-light border-dark" id="email" name="email" placeholder="Ex: admin@kbrtec.com.br">
                    </div>
                </div>
