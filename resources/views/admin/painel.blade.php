                ...
                <div class="item">
                    ...
                    <div class="collapse show" id="menu-usuario">
                        <div class="bg-dark d-flex flex-column rounded mx-4 p-2 row-gap-1">
                            ...
                            <a href="{{ route('admin.index') }}" class="submenu-link link-light text-decoration-none rounded p-2 active">
                                <small class="d-flex justify-content-between align-items-center">
                                    Listagem
        ...
        <main class="col h-100 text-light p-4">
            <div class="d-flex justify-content-between mb-4">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.create') }}" class="btn btn-light">+ Cadastrar Usuário</a>
                </div>
            </div>

            <div class="d-flex justify-content-between align-items-end mb-3">
                <form action="{{ route('admin.index') }}" class="bg-custom rounded col-12 py-3 px-4">
            ...
            <div class="bg-custom rounded overflow-hidden">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <button type="button" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" data-bs-toggle="modal" data-bs-target="#userDetailsModal{{ $user->id }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                                        </svg>
                                    </button>

                                    <a href="{{ route('admin.edit', $user) }}" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Editar">
                                    ...
                                    @method('DELETE')
                                    @csrf
                                    <button type="submit" onclick="return confirm('Tem certeza que deseja apagar esse usuário?')" class="btn btn-danger d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Deletar">
                ...
                @empty
                    <tr>
                        <td colspan="3" style="color: red">Nenhum usuário encontrado!</td>
                    </tr>      
                @endforelse
                </table>
            </div>
