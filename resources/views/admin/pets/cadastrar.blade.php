...
<body class="bg-dark h-100">
    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
            ...
            <div class="menu">
                ...
                <div class="item animais">
                    ...
                    <div class="collapse show" id="menu-animais">
                        <div class="bg-dark d-flex flex-column rounded mx-4 p-2 row-gap-1">
                            <a href="{{ route('admin.pets.create') }}" class="submenu-link link-light text-decoration-none rounded p-2 active">
                                <small class="d-flex justify-content-between align-items-center">
                                    Cadastrar
                                </small>
                            </a>
        ...
        <main class="col h-100 text-light p-4">
            ...
            <form action="{{ route('admin.pets.store') }}" method="post" class="bg-custom rounded col-12 py-3 px-4" enctype="multipart/form-data">
                @csrf
                <div class="mb-3 row">
                    <label for="usuario" class="col-sm-2 col-form-label">Nome</label>
                    <div class="col-sm-10">
                        <input type="text" value="{{ old('name', "") }}" class="form-control bg-dark text-light border-dark" id="usuario" name="name" placeholder="Ex: Roby">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select name="specie" class="form-control bg-dark text-light border-dark form-select" id="specie">
                            <option value="{{ old('specie', "") }}" disabled selected>Selecione</option>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select name="breed" class="form-control bg-dark text-light border-dark form-select" id="breed">
                            <option value="{{ old('breed', "") }}" disabled selected>Selecione</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="age" value="{{ old('age', "") }}" class="form-control bg-dark text-light border-dark" id="age" placeholder="Ex: 2">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="confSenha" class="col-sm-2 col-form-label">Peso:</label>
                    <div class="col-sm-10">
                        <input type="text" name="weight" value="{{ old('weight', "") }}" class="form-control bg-dark text-light border-dark" id="weight" placeholder="Ex: 10">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="confSenha" class="col-sm-2 col-form-label">Porte:</label>
                    <div class="col-sm-10">
                        <input type="text" name="size" value="{{ old('size', "") }}" class="form-control bg-dark text-light border-dark" id="size" placeholder="Ex: Médio">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="confSenha" class="col-sm-2 col-form-label">Local:</label>
                    <div class="col-sm-10">
                        <input type="text" name="local" value="{{ old('local', "") }}" class="form-control bg-dark text-light border-dark" id="local" placeholder="Ex: São Paulo">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="confSenha" class="col-sm-2 col-form-label">Sobre o pet:</label>
                    <div class="col-sm-10">
                        <textarea name="about" aria-valuetext="{{ old('about', "") }}" class="form-control bg-dark text-light border-dark" id="about" style="resize: none;"></textarea>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="confSenha" class="col-sm-2 col-form-label">Escolha suas imagens:</label>
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); grid-gap: 20px">
                        <input name="image1" value="{{ old('image1', "") }}" id="image1" type="file" class="form-control bg-dark text-light border-dark" style="width: 350px">
                        <input name="image2" value="{{ old('image2', "") }}" id="image2" type="file" class="form-control bg-dark text-light border-dark" style="width: 350px">
                        <input name="image3" value="{{ old('image3', "") }}" id="image3" type="file" class="form-control bg-dark text-light border-dark" style="width: 350px">
                        <input name="image4" value="{{ old('image4', "") }}" id="image4" type="file" class="form-control bg-dark text-light border-dark" style="width: 350px">
                        <input name="image5" value="{{ old('image5', "") }}" id="image5" type="file" class="form-control bg-dark text-light border-dark" style="width: 350px">
                    </div>
                </div>
                @if ($errors->any())
