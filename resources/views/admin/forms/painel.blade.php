...
<body class="bg-dark h-100">
    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
            ...
            <div class="menu">
                ...
                <div class="item adocoes">
                    ...
                    <div class="collapse show" id="menu-adocoes">
                        <div class="bg-dark d-flex flex-column rounded mx-4 p-2 row-gap-1">
                            <a href="{{ route('admin.forms.index') }}" class="submenu-link link-light text-decoration-none rounded p-2 active">
                                <small class="d-flex justify-content-between align-items-center">
                                    Listagem
        ...
        <main class="col h-100 text-light p-4">
            <div class="d-flex justify-content-between mb-4">
                <h1 class="h3">Formulários de Adoção</h1>

                <div class="d-flex gap-2">
                    <a href="{{ route('download.pdf') }}" class="btn btn-light" title="PDF">
                    ...
                    <a href="{{ route('download.csv') }}" class="btn btn-light" title="Excel">
                ...
                <form action="" class="bg-custom rounded col-12 py-3 px-4">
                    ...
                    <div class="row align-items-end row-gap-4">
                        <div class="col-3 d-flex flex-wrap">
                            ...
                            <div class="col-12">
                                <input type="text" name="name" class="form-control bg-dark text-light border-dark" id="search" placeholder="Ex: admin">
                            </div>
                        </div>
                        ...
                        <div class="col-3 d-flex flex-wrap">
                            ...
                            <div class="col-12">
                                <input type="text" name="pet" class="form-control bg-dark text-light border-dark" id="search" placeholder="Ex: Roby">
                            </div>
                        </div>
                        ...
                        <div class="col-5 row">
                            ...
                            <div class="col-6 d-flex gap-2">
                                <input type="text" name="created_at" class="form-control bg-dark text-light border-dark" id="de" placeholder="27/10/2023">
                            </div>
                        </div>
            ...
            <div class="bg-custom rounded overflow-hidden">
                <table class="table mb-0 table-custom table-dark align-middle">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-uppercase">Pet</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <button type="button" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" data-bs-toggle="modal" data-bs-target="#userDetailsModal{{ $form->id }}">
                                    ...
                                    @method('DELETE')
                                    @csrf
                                    <button type="submit" onclick="return confirm('Tem certeza que deseja apagar esse formulário?')" class="btn btn-danger d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Deletar">
                ...
                @empty
                    <tr>
                        <td colspan="3" style="color: red">Nenhum formulário encontrado!</td>
                    </tr>      
                @endforelse
                </table>
            </div>
    ...
    <div class="modal fade" id="userDetailsModal{{ $form->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered text-light">
            <div class="modal-content bg-custom">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Formulário</h1>
                ...
                <div class="modal-body d-flex flex-wrap row-gap-4">
                    ...
                    <div class="col-6">
                        <div><small>Animal Procurado:</small></div>
                        <div>{{ $form->pet }}</div>
                    </div>
