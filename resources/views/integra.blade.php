            ...
            <div class="row align-items-center">
                <div class="col-4">
                    <a href="index.html" title="KBR TEC" class="d-inline-block">
                        <h1>
                            <img src="{{asset('img/logo.png')}}" alt="KBR TEC" width="150">
                        </h1>
                    </a>
                </div>
    ...
    <nav aria-label="breadcrumb" class="p-3 bg-custom-light">
        <div class="container">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item active fs-sm" aria-current="page">{{ $pet->name }}</li>
            </ol>
        </div>
    </nav>
        ...
        <div class="container mb-5">
            <div class="row align-items-start">
                <div class="col-8 d-flex">
                    <div class="col-3 d-flex flex-wrap row-gap-3">
                        <div class="col-12 rounded overflow-hidden">
                            <img src="{{ asset('/img/pets/' . $pet->image2) }}" alt="{{ $pet->name }}" class="object-fit-cover w-100" height="120">
                        </div>

                        <div class="col-12 rounded overflow-hidden">
                            <img src="{{ asset('/img/pets/' . $pet->image3) }}" alt="{{ $pet->name }}" class="object-fit-cover w-100" height="120">
                        </div>

                        <div class="col-12 rounded overflow-hidden">
                            <img src="{{ asset('/img/pets/' . $pet->image4) }}" alt="{{ $pet->name }}" class="object-fit-cover w-100" height="120">
                        </div>

                        <div class="col-12 rounded overflow-hidden">
                            <img src="{{ asset('/img/pets/' . $pet->image5) }}" alt="{{ $pet->name }}" class="object-fit-cover w-100" height="120">
                        </div>
                    </div>

                    <div class="col-9 rounded overflow-hidden">
                        <img src="{{ asset('/img/pets/' . $pet->image1) }}" alt="{{ $pet->name }}" class="object-fit-cover w-100 ms-3" height="530">
                    </div>
                </div>
                ...
                <div class="py-3 col-4 d-flex flex-wrap row-gap-3">                   
                    ...
                    <div class="col-12">
                        <a href="{{ route('form', ['name' => Str::slug($pet->name)]) }}" class="btn btn-custom mt-5 w-100 d-flex align-items-center justify-content-center gap-2">
                            Solicitar adoção
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="https://www.kbrtec.com.br/" target="_blank" title="Acesse o site da KBR TEC">
                    <img src="{{asset('img/kbrtec.png')}}" alt="KBRTEC" width="100">
                </a>
            </div>
        </div>
    </footer>
